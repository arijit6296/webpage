...
function Contact() {
  return (
    <>
      <ProductBanner BannerTitle={"Contact"} />
      <div class="container-xl my-5">
        <h3 class="container-head">Get In Touch With Us</h3>
        ...
        <div class="row my-5">
          <div class="col-md-6 col-11 mx-auto mt-5 ">
            <div class="address">
              <div class="svg">
                <svg
                  width="22"
          ...
          <form>
              ...
              <div class="marge-div2">
                <div class="input-box2">
                  <div class="input-type2">
                    <label for="massage">Subject</label>
                  </div>
                  <div class="input-type2">
                    <textarea
                      name="massage"
